...
- `workflow_veille_ia.json` — fichier d'export n8n (importable directement)
- `screenshot_workflow.png` — vue complète du pipeline
- `exemple_briefing.png` — exemple de rendu email (optionnel)
